...
export class IonSimpleWizard {
  ...
  @Input() formValidated: boolean = true;//Default
  ...
  constructor(public evts: Events,private cdRef:ChangeDetectorRef) {
  }
 ...
 */
  isFormValidated() {
    console.log("is form validated :"+this.formValidated);
